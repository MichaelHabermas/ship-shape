...
const ADMIN_CREDENTIALS_APP_JS = join(__dirname, '../static/admin-credentials-app.js');
...
<body>
  ...
  <script src="/api/admin/credentials/app.js" defer></script>
</body>
</html>
  `;
}
...
/**
 * GET /api/admin/credentials/app.js - Page script (super-admin only)
 */
router.get('/app.js', authMiddleware, superAdminMiddleware, (_req: Request, res: Response): void => {
  res.type('application/javascript');
  res.sendFile(ADMIN_CREDENTIALS_APP_JS);
});
