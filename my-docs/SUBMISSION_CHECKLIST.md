...
| Reviewer Evidence Bundle | `my-docs/reviewer-evidence-bundle/index.html` | Ready for separate Render Static Site | Generated by `pnpm submission:render-bundle`; intended service name `ship-shape-reviewer-evidence`, publish directory `my-docs/reviewer-evidence-bundle`, no SPA rewrite. |
