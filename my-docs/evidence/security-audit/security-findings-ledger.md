...
|----|-------|----------|--------|------------|-------------------|--------|------------------|
| SS-FIND-001 | — Governance approval forgery via document `properties` mass assignment | critical | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | api/src/routes/documents.ts |
| SS-FIND-002 | — RACI self-elevation grants real approval authority | critical | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | api/src/routes/programs.ts, documents.ts |
| SS-FIND-003 | — Week lifecycle bypass via ungoverned `status` PATCH | critical | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | api/src/routes/weeks/sprints.ts, documents.ts |
| SS-FIND-004 | — Weekly plan IDOR via generic documents REST API | high | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | api/src/routes/documents.ts vs weekly-plans.ts |
| SS-FIND-005 | — Weekly plan IDOR via collaboration WebSocket | high | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | api/src/collaboration/index.ts |
...
| SS-FIND-007 | — Bulk issue move to private sprint/project without visibility check | medium | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | api/src/routes/issues.ts |
| SS-FIND-008 | — File access is workspace-scoped, not document-scoped | medium | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | api/src/routes/files.ts |
...
| SS-FIND-010 | — Dashboard `my-focus` leaks private project/program metadata | medium | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | api/src/routes/dashboard.ts |
...
| SS-FIND-012 | — Public feedback lacks dedicated anti-abuse controls | medium | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | api/src/routes/feedback.ts |
...
| SS-FIND-017 | — Session IP/User-Agent stored but never enforced | medium | fixed | 2026-05-22 | 2026-05-24 (manual/pass) | no | session-auth.ts, auth.ts |
...
| SS-FIND-019 | — CAIA `returnTo` weak validation | low | fixed | 2026-05-22 | 2026-05-24 (manual/status_change) | no | api/src/routes/caia-auth.ts |
| SS-FIND-020 | — Super-admin SSRF via CAIA issuer URL | medium | fixed | 2026-05-22 | 2026-05-24 (manual/pass) | no | admin-credentials.ts, services/caia.ts |
...
| SS-FIND-025 | — Pending file upload hijacking | high | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | api/src/routes/files.ts |
| SS-FIND-026 | — Cross-site WebSocket session riding (no Origin validation) | high | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | api/src/collaboration/index.ts |
...
| SS-FIND-029 | — Super-admin cross-workspace access without membership | high | fixed | 2026-05-22 | 2026-05-30 (probe/pass) | no | workspaces.ts, document-access.ts |
...
| SS-FIND-034 | — Full OpenAPI schema exposed without authentication | low | fixed | 2026-05-22 | 2026-05-24 (manual/status_change) | no | api/src/swagger.ts |
...
| Last verification | 2026-05-30T01:15:43.462Z — probe pass (stillActive: false) |
...
| Last verification | 2026-05-24T19:55:48.515Z — manual status_change (stillActive: false) |
...
| Last verification | 2026-05-24T19:55:05.774Z — manual status_change (stillActive: false) |
...
| Last verification | 2026-05-24T19:55:15.285Z — manual status_change (stillActive: false) |
...
| Last verification | 2026-05-24T19:55:56.717Z — manual status_change (stillActive: false) |
...
| Last verification | 2026-05-24T20:45:26.913Z — manual pass (stillActive: false) |
...
| Last verification | 2026-05-24T20:35:26.283Z — manual status_change (stillActive: false) |
...
| Last verification | 2026-05-24T20:45:23.872Z — manual pass (stillActive: false) |
...
| Last verification | 2026-05-24T19:55:23.244Z — manual status_change (stillActive: false) |
...
| Last verification | 2026-05-24T20:35:26.310Z — manual status_change (stillActive: false) |
...
| Last verification | 2026-05-24T19:55:31.687Z — manual status_change (stillActive: false) |
...
| Last verification | 2026-05-24T19:56:06.334Z — manual status_change (stillActive: false) |
...
| Last verification | 2026-05-24T19:55:39.403Z — manual status_change (stillActive: false) |
...
| Last verification | 2026-05-24T20:35:32.579Z — manual status_change (stillActive: false) |
...
| Last verification | 2026-05-24T20:35:32.592Z — manual status_change (stillActive: false) |
...
*Generated at 2026-05-30T01:15:43.751Z from security-findings.json*
