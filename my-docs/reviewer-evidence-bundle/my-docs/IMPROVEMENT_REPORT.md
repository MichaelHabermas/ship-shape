...
- Kept `my-docs/evidence/submission-ledger.json` unchanged because no category status, acceptance result, measurement, or claim basis changed.
...
- Prior closeout bundle stats (comparison): `my-docs/evidence-runs/cat2-closeout/collectors/bundle-stats.json`.
