...
- First full post-lane E2E baseline on 2026-05-20: `E2E_RESULTS_DIR=test-results/full-run pnpm test:e2e:run` finished in 6.6 minutes with 862 passed, 1 failed, 6 flaky. The hard accessibility tree auto-expand failure looked like a stale selector against the newer ARIA `group` tree shape; the selector has been updated, but focused E2E verification is still blocked until Docker/Testcontainers is running.
