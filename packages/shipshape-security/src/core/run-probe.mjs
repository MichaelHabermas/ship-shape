import { buildConfig } from './cli.mjs';
import { ProbeHttpClient } from './http-client.mjs';
import { buildReport, writeReport } from './report.mjs';
import { SEVERITY_ORDER } from './result-model.mjs';
import { MEASURED_SURFACE_COUNT, selectedGroups } from './registry.mjs';
import {
  loadFindingRegistry,
  loadSecurityFindings,
  appendProbeVerifications,
  triageFindings,
} from './finding-registry.mjs';
import { shouldFailSecurityProbeRun } from './ci-fail.mjs';

export async function runProbe(argv = [], env = process.env) {
