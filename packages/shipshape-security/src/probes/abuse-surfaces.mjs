...
import { fail, finding, pass, skip } from '../core/result-model.mjs';
import { runSelectedProbes } from '../core/probe-selection.mjs';
import { fingerprintForFinding } from '../core/finding-registry.mjs';
import { ProbeHttpClient } from '../core/http-client.mjs';
...
async function publicFeedbackRateLimit({ config, clients }) {
  const { pickProgram } = await import('../core/fixtures.mjs');
