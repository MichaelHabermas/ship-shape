...
1. Open `my-docs/project-weeks-sot/week-4/reviewer-dashboard.html`.
...
2. Open `my-docs/project-weeks-sot/week-4/SUBMISSION_CHECKLIST.md`.
...
3. Use `my-docs/evidence/submission-ledger.json` as the claim source of truth.
   ...
   - Generated views come from the ledger: `my-docs/project-weeks-sot/week-4/reviewer-dashboard.html` and the Current Ledger Truth block in `my-docs/project-weeks-sot/week-4/IMPROVEMENT_REPORT.md`.

## What To Check

| Question | Go To |
| --- | --- |
| Did every category hit the source target? | `my-docs/project-weeks-sot/week-4/SUBMISSION_CHECKLIST.md` -> Category Proof Map |
| What is the canonical status for each category? | `my-docs/evidence/submission-ledger.json` |
| What changed and why? | `my-docs/project-weeks-sot/week-4/IMPROVEMENT_REPORT.md` |
| What were the audit baselines? | `my-docs/project-weeks-sot/week-4/AUDIT_REPORT.md` |
| What was the original Week 4 assignment? | `my-docs/project-weeks-sot/week-4/GFA-Week-4-ShipShape.txt` |
| What was the Category 8 security assignment? | `my-docs/project-weeks-sot/week-4/Shipshape-Security-Audit.txt` |
| What did the codebase orientation cover? | `my-docs/project-weeks-sot/week-4/Codebase-Orientation-Checklist.md` |
| What discoveries were made? | `my-docs/project-weeks-sot/week-4/discovery-research-log.md` |
| What did AI cost and help with? | `my-docs/AI_COST_ANALYSIS.md` |
| How do I run the app? | `README.md` |

## Category Proof

Use `my-docs/project-weeks-sot/week-4/SUBMISSION_CHECKLIST.md` first. It maps each category to:
...
For Category 8, start with the Security tab in `my-docs/project-weeks-sot/week-4/reviewer-dashboard.html`.
...
Then use category-specific commands from `my-docs/project-weeks-sot/week-4/SUBMISSION_CHECKLIST.md` only when you want to reproduce a specific claim.
...
2. `my-docs/project-weeks-sot/week-4/SUBMISSION_CHECKLIST.md`
3. `my-docs/project-weeks-sot/week-4/reviewer-dashboard.html`
4. `my-docs/project-weeks-sot/week-4/IMPROVEMENT_REPORT.md`
