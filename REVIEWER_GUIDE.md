...
| 9 | Regression suite + perf within +10% | Not runnable from the deployed site alone | **CI on `main` passes** (Playwright + API tests). See [GitHub Actions](https://github.com/MichaelHabermas/ship-shape/actions) |
